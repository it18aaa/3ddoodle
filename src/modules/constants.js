export const EVENTS = Object.freeze({
    ...
    CREATE_GRASS: Symbol("CREATE_GRASS"),
    CREATE_PATIO: Symbol("CREATE_PATIO"),
    CREATE_BORDER: Symbol("CREATE_BORDER"),
    GUI_WHITE_FENCE: Symbol("GUI_WHITE_FENCE"),
    GUI_LIGHT_FENCE: Symbol("GUI_LIGHT_FENCE"),
    GUI_BLUE_FENCE: Symbol("GUI_BLUE_FENCE"),
    GUI_TEXTURE_FENCE: Symbol("GUI_TEXTURE_FENCE")
});